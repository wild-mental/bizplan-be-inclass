# REQ-FUNC-008-AI-001: PMF 진단 통합 구현

## 1. 개요
- **목표**: 사용자의 PMF 설문 응답을 분석하여 PMF 단계(Stage), 리스크, 개선 권고를 도출하는 LLM 기반 진단 기능을 구현한다.
- **범위**:
...
- **Out of Scope**: 진단 이력 관리(Backend DB 역할), 별도 AI 엔진 서비스.
...
title: "PMF 진단 및 리포트 생성 LLM 통합 구현"
summary: >
  Spring Boot 서비스에서 Gemini API를 직접 호출하여 PMF 진단 전용 프롬프트 파이프라인을 구축하고,
...
steps_hint:
  ...
  - "Spring AI를 통한 Gemini API 호출 구현"
  - "Service 레이어에서 PMF 진단 로직 구현"
